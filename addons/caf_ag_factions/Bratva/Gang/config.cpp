...
class CfgVehicles
{
	...
	class CAF_AG_BRA_R_OFFICER: CAF_AG_BRA_R_BASE
	{
		...
		{
			init = "(_this select 0) forceAddUniform ""TRYK_U_B_C01_Tsirt""";
		};
	};
	class CAF_AG_BRA_R_TEAMLEADER: CAF_AG_BRA_R_BASE
	{
		...
		class EventHandlers: EventHandlers
		{
			init = "(_this select 0) forceAddUniform ""TRYK_U_B_PCUODs""";
		};
	};
	class CAF_AG_BRA_R_SQUADLEADER: CAF_AG_BRA_R_BASE
	{
		...
		class EventHandlers: EventHandlers
		{
			init = "(_this select 0) forceAddUniform ""TRYK_U_pad_j_blk""";
		};
	};
	class CAF_AG_BRA_R_EOD: CAF_AG_BRA_R_BASE
	{
		...
		class EventHandlers: EventHandlers
		{
			init = "(_this select 0) forceAddUniform ""TRYK_T_camo_wood_marpat_BG""";
		};
	};
	class CAF_AG_BRA_R_SUPPORT: CAF_AG_BRA_R_BASE
	{
		...
		class EventHandlers: EventHandlers
		{
			init = "(_this select 0) forceAddUniform ""TRYK_T_camo_Wood""";
		};
	};
	class CAF_AG_BRA_R_MEDIC: CAF_AG_BRA_R_BASE
	{
		...
		class EventHandlers: EventHandlers
		{
			init = "(_this select 0) forceAddUniform ""TRYK_U_B_BLOD_T""";
		};
	};
	class CAF_AG_BRA_R_AT: CAF_AG_BRA_R_BASE
	{
		...
		class EventHandlers: EventHandlers
		{
			init = "(_this select 0) forceAddUniform ""TRYK_U_B_Wood_PCUs_R""";
		};
	};
	...
	class CAF_AG_BRA_R_GRENADIER: CAF_AG_BRA_R_BASE
	{
		...
		class EventHandlers: EventHandlers
		{
			init = "(_this select 0) forceAddUniform ""TRYK_T_camo_wood_marpat""";
		};
	};
	class CAF_AG_BRA_R_RIFLEMAN: CAF_AG_BRA_R_BASE
	{
		...
		class EventHandlers: EventHandlers
		{
			init = "(_this select 0) forceAddUniform ""TRYK_T_BLK_PAD""";
		};
	};
	class CAF_AG_BRA_R_SHARPSHOOTER: CAF_AG_BRA_R_BASE
	{
		...
		class EventHandlers: EventHandlers
		{
			init = "(_this select 0) forceAddUniform ""TRYK_U_pad_hood_odBK""";
		};
	};
	class CAF_AG_BRA_R_SNIPER: CAF_AG_BRA_R_BASE
	{
		...
		class EventHandlers: EventHandlers
		{
			init = "(_this select 0) forceAddUniform ""U_O_FullGhillie_sard""";
		};
	};
