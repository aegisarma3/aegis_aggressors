...
//Class caf_ag_factions : MiddleEast\Tribal\Groups\motorized\config.bin{
class CfgPatches
{
	class caf_ag_me_t_mtr
	{
		units[] = {};
		weapons[] = {};
		requiredVersion = 0.1;
		...
		class caf_ag_me_t
		{
			...
			class Motorized_MTP
			{
				...
				class Technicals_me_t
				{
					...
					{
						side = 0;
						vehicle = "caf_ag_me_t_Offroad_armed_01";
						rank = "PRIVATE";
						position[] = {3,0,0};
					};
					class Unit1
