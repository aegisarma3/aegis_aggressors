...
//Class caf_ag_equip_c : EastEurope\Uniforms\eur_fatigues_02\config.bin{
class DefaultEventhandlers;
class CfgPatches
{
	class caf_ag_equip_EEUR_fatigues_02
	{
		units[] = {};
		weapons[] = {};
		requiredVersion = 0.1;
...
class CfgWeapons
{
	...
	class Uniform_Base;
	class U_CAF_AG_EEUR_FATIGUES_02: Uniform_Base
	{
		scope = 2;
		displayName = "East Europe Fatigues 2";
		model = "\A3\Characters_F\Common\Suitpacks\suitpack_blufor_diver";
		class ItemInfo: UniformItem
		{
			uniformModel = "-";
			uniformClass = "CAF_AG_EEUR_FATIGUES_02";
			containerClass = "Supply20";
			uniformType = "Default";
			mass = 80;
		};
	};
	class U_CAF_AG_EEUR_FATIGUES_02a: U_CAF_AG_EEUR_FATIGUES_02
	{
		displayName = "East Europe Fatigues 2a";
		class ItemInfo: UniformItem
		{
			uniformClass = "CAF_AG_EEUR_FATIGUES_02a";
			uniformModel = "-";
			containerClass = "Supply20";
			uniformType = "Default";
			mass = 80;
...
class CfgVehicles
{
	...
	class CAF_AG_EEUR_FATIGUES_02: O_Soldier_F
	{
		scope = 1;
		author = "CAF MOD TEAM";
		armor = 0.5;
		...
		hiddenselectionstextures[] = {"\caf_ag_equip_t\tex\ig_che_1_1_co.paa"};
		class Wounds
		{
	...
	class CAF_AG_EEUR_FATIGUES_02a: CAF_AG_EEUR_FATIGUES_02
	{
		uniformClass = "U_CAF_AG_EEUR_FATIGUES_02a";
		hiddenselections[] = {"Camo"};
		hiddenselectionstextures[] = {"\caf_ag_equip_t\tex\ig_che_1_2_co.paa"};
	};
};
//};
