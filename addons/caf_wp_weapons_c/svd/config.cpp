...
//Class caf_wp_weapons_c : svd\config.bin{
class CfgPatches
{
	class caf_wp_weapons_svd
	{
		units[] = {};
		weapons[] = {"caf_svd"};
		requiredVersion = 0.1;
...
class cfgWeapons
{
	...
	class caf_svd: AK_BASE
	{
		...
		class Library
		{
			libtextdesc = "The SVD was designed as a sharpshooter's rifle rather than a sniper rifle. In fact the main role of the SVD in the Soviet Army was to increase the effective range of an infantry squadâs fire to 600 meters by providing precision fire support.<br/>The SVD is a lightweight, accurate rifle capable of semi-auto fire and equipped with a 4x24 PSO-1 scope. The SVD is extremely reliable in all conditions.";
		};
	};
};
//};
